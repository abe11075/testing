...
function Library:CreateWindow(config)
    ...
    -- Transparansi window itu MURAH saat diam (engine composite sekali, cache),
    -- tapi MAHAL saat posisi berubah tiap frame (alpha compositing ulang terus
    -- menerus) -> itulah yang bikin FPS anjlok + drag terasa kasar saat digeser.
    -- Solusi: saat drag/resize aktif, jadikan window OPAQUE (0) biar nol biaya
    -- alpha -> FPS stabil -> drag mulus. Saat dilepas, kembalikan transparansi
    -- semula. Visual tetap transparan saat idle/diam, solid hanya saat digeser.
    -- Tidak ada RenderStepped/loop per-frame: posisi di-set langsung dari input,
    -- yang sekarang halus karena frame budget tidak lagi habis oleh alpha compositing.
