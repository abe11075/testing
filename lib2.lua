...
function Library:CreateButton(parent, label, callback)
    ...
    local button = new("TextButton", {
        ...
        TextSize = fontSize.normal,
        TextColor3 = colors.text,
        -- Efek gelap saat ditekan di-handle native oleh engine lewat
        -- AutoButtonColorProperties, jadi tidak butuh 3 connection Lua
        -- (Down/Up/Leave) hanya untuk feedback warna. Warna dipindah dari
        -- btnFrame ke button supaya efek tekan benar-benar terlihat.
        AutoButtonColor = true,
        AutoButtonColorProperties = {
            BackgroundColor3 = Color3.new(colors.primary.R * 0.7, colors.primary.G * 0.7, colors.primary.B * 0.7),
            BackgroundTransparency = 0,
        },
        ZIndex = 9
    })
