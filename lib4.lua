    ...
    function WindowObject:AddTab(tabConfig)
        ...
        function TabObject:AddSection(sectionTitle, isOpen)
            ...
            function SectionObject:AddParagraph(paragraphConfig)
                ...
                -- Tinggi frame & label dihitung native oleh AutomaticSize. Berbeda
                -- dari bug Section, di sini background (frame) ada DI DALAM kontainer
                -- transparan yang juga AutomaticSize, jadi render lag AutomaticSize
                -- tidak kelihatan dan reliably benar. Ini menggantikan mekanisme
                -- reflow manual (TextBounds + task.defer + 2 connection) dulu.
