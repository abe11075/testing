...
function Library:Window(config)
    ...
    Library._pendingFirstPage = nil
    Library._suspendPageSwitch = true
    ...
    local IDLE_THRESHOLD = 0.12 -- 120ms tanpa aktivitas build = build dianggap selesai
    local EXTRA_DELAY    = 0.03 -- kasih 30ms ekstra setelah idle biar layout settle
    local IDLE_POLL      = 0.03
