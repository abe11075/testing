...
-- BUILD_BUDGET_MS = 14ms < 1 frame (16.6ms @60fps) -> konten lebih cepat muncul,
-- tapi instance creation tersebar ke beberapa frame sehingga load awal tidak
-- membekukan UI.
local BUILD_BUDGET_MS = 14
local CHECK_EVERY = 64 -- cek waktu tiap 64 instance
...
function Library:Window(config)
    ...
    local IDLE_THRESHOLD = 0.02 -- 20ms tanpa aktivitas build = build dianggap selesai
    local EXTRA_DELAY    = 0 -- tidak tahan ekstra; langsung init begitu idle
