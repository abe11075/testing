...
function Library.ConfigSystem.Save()
    if not _G.LynxCloudURL or not _G.LynxCloudSecret or not http_request then return false end
    local ok, err = pcall(function()
        local url = _G.LynxCloudURL .. "/config?uid=" .. tostring(localPlayer.UserId)
