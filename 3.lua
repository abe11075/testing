...
function Library:Window(config)
    ...
    -- === Build-time smoother ===
    -- Aktifkan frame-budget yielding di new() selama fase build. Instance
    -- creation jadi tersebar ke beberapa frame -> tidak membekukan UI saat
    -- execute (penyebab "crash sedikit" sebelumnya).
